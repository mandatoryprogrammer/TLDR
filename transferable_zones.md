...
* `cd` via `ns-root-3.scpt-network.com.`: [Click here to view zone data.](archives/cd/ns-root-3.scpt-network.com.zone)
* `cd` via `ns-root-4.scpt-network.com.`: [Click here to view zone data.](archives/cd/ns-root-4.scpt-network.com.zone)
...
* `mo` via `e.monic.mo.`: [Click here to view zone data.](archives/mo/e.monic.mo.zone)
...
* `xn--mix891f` via `e.monic.mo.`: [Click here to view zone data.](archives/xn--mix891f/e.monic.mo.zone)
